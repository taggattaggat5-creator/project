...
import { ArrowLeft, FlaskConical, Clock, Tag, Flag, CircleCheck as CheckCircle2, Circle as XCircle, Send, Lightbulb, Terminal, Server, CircleAlert as AlertCircle, Play, Pause, ExternalLink, Trophy, PartyPopper, Zap, Loader2 } from 'lucide-react';
    ...
    <div className="animate-fade-in">
          ...
          <div className="mt-5 pt-5 border-t border-cyber-border">
            {machineProvisioning ? (
              ...
              <div className="space-y-3">
                ...
                <p className="text-xs text-[#00ff9d] flex items-center gap-1.5 font-mono">
      ...
      {isAutomated && profile?.role === 'etudiant' && machineRunning && (
        <div className="card p-6 mb-6">
          ...
          {n8nFlagSolved ? (
            <div className="flex items-center gap-2 p-4 rounded-lg bg-[#00ff9d]/10 border border-[#00ff9d]/20 text-sm text-[#00ff9d] font-mono">
